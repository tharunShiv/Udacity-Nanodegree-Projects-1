(function () {
    ...
    form.addEventListener('submit', function (e) {
        ...
        unsplashRequest.setRequestHeader('Authorization', 'Client-ID ' + myUnsplashKey);
       ...
       articleRequest.open('GET', `http://api.nytimes.com/svc/search/v2/articlesearch.json?q=${searchedForText}&api-key=` + myNYTkey);
       articleRequest.send();
    });
})();
